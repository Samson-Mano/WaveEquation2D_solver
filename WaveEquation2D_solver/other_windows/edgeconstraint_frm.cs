    ...
    public partial class edgeconstraint_frm : Form
    {
        ...
        private void button_applyconstraint_Click(object sender, EventArgs e)
        {
            ...
            if(radioButton_boundaryconditions.Checked == true)
            {
                ...
                {
                    int start_pt_id = modeldata.fe_data.meshdata.mesh_boundaries.lineMap[edgeid].start_pt_id;
                    int end_pt_id = modeldata.fe_data.meshdata.mesh_boundaries.lineMap[edgeid].end_pt_id;
